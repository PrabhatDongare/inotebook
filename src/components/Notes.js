...
const Notes = (props) => {
    ...
    const { notes, getNote, editNote } = context     // D-structuring
    ...
    // Copied onChange and handleCLick for form
    const handleClick = (e) => {
        // console.log("Updating this note", note)
        editNote(note.id, note.etitle, note.edescription, note.etag)
        refClose.current.click()    // Close model after clicking on Update Note button
    ...
    return (
        <>
            ...
            <div className="row my-3">
                ...
                {notes.map((note) => {          // using mapping to bring content from noteState
                console.log(note)
